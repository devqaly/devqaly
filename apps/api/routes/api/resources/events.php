...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('events/networkRequest/byRequestId/{networkRequestEvent:request_id}/databaseTransactions', [EventController::class, 'getDatabaseTransactionsByRequestId']);
