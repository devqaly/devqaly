<template>
  ...
  >
    ...
    <div class="text-gray-500 mt-2">New Url</div>
...
import type { UrlChanged } from '@/services/api/resources/session/events/codec'
...
const props = defineProps<Props<UrlChanged>>()
</script>
