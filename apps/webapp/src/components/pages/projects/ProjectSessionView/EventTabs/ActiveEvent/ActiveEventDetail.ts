...
import ChangeUrlDetails from '@/components/pages/projects/ProjectSessionView/EventTabs/ActiveEvent/types/ChangeUrlDetails.vue'
import DatabaseTransactionDetails from '@/components/pages/projects/ProjectSessionView/EventTabs/ActiveEvent/types/DatabaseTransactionDetails.vue'
import ElementClickDetails from '@/components/pages/projects/ProjectSessionView/EventTabs/ActiveEvent/types/ElementClickDetails.vue'
import NetworkEventDetails from '@/components/pages/projects/ProjectSessionView/EventTabs/ActiveEvent/types/NetworkEventDetails.vue'
