...
Here's the detailed information recorded when a user scrolls during a session:

- **Source**: The origin of the event, always from your frontend.
- **Inner Width**: Total width (in pixels) of the visible screen.
- **Inner Height**: Total height (in pixels) of the visible screen.
