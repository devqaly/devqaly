...
```php
// You can use named arguments from PHP 8.0
// @see https://www.php.net/manual/en/functions.arguments.php#functions.named-arguments
$devqaly = new Devqaly\DevqalyClient(securityToken: '<SECURITY-TOKEN>');

// OR without named arguments
$devqaly = new Devqaly\DevqalyClient(null, null, '<SECURITY-TOKEN>');
...
$devqaly = new Devqaly\DevqalyClient(
    backendUrl: 'https://api-devqaly.my-domain.com',
...
$devqaly = new Devqaly\DevqalyClient(
    backendUrl: 'https://api-devqaly.my-domain.com',
    sourceIdentifier: 'authentication-service',
    securityToken: '<SECURITY-TOKEN>'
);
